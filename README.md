...
I aim to write simple, readable, eloquent code that makes developers' lives easier when it's time to troubleshoot and refactor. I enjoy full stack development, dealing with loads of data and building functional front end designs (especially geospatial data and data visualizations).
